            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul class="font-medium flex flex-col items-center p-4 md:p-0 mt-4 md:flex-row md:space-x-6 space-y-5 md:space-y-0" id="navLinks">
                        ...
                        <li>
                            <a href="/serviceProviders.html" class="py-2 px-3 font-normal text-cus-maron-100 lg:text-lg hover:font-semibold hover:bg-cus-maron hover:!text-primary-color-7 hover:transition 500 hover:rounded" aria-current="page">Find Service Provider</a>
                        </li>
