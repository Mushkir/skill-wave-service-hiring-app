<form method="post" class=" h-screen w-screen z-50 backdrop-blur-sm absolute left-[50%] top-[40%] -translate-x-[50%] -translate-y-[50%] hidden" id="editDistrictForm">
    <div class=" w-full max-w-[500px] shadow-md rounded-lg px-8 pt-4 pb-8 mb-4 bg-[#6D2932] absolute left-[50%] top-[40%] -translate-x-[50%] -translate-y-[50%]">
        ...
        <div class="mb-4 mt-5">
            ...
            <label class="block text-[#e3dbd1] mb-2" for="districtName">
                District
            </label>
            <input type="text" class="shadow appearance-none border rounded-lg outline-none w-full py-2 px-3 text-gray-700 leading-tight bg-gray-200" id="districtName" name="districtName">
        </div>
