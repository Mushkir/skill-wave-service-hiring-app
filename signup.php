...
<body>
    ...
    <main class="mt-[6.25rem] px-3 sm:px-20">
        ...
        <section class="pt-24 max-w-8xl mx-auto">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="bg-cus-maron text-primary-color-10 w-full hover:text-white rounded-md">
    ...
    <!-- JS Code of Service Seekers Page Show & Hide Password -->
    <script src="./assets/js/ss-show-and-hide-password.script.js"></script>

    <!-- JS Code of Service Providers Page Show & Hide Password -->
    <script src="./assets/js/sp-show-and-hide-password.script.js"></script>
